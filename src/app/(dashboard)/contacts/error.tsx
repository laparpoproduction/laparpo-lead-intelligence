...
export default function ContactsError({
  ...
  useEffect(() => {
    logger.error("Contacts interface failed", {
  ...
  return (
    <div className="grid min-h-80 place-items-center rounded-2xl border border-red-200 bg-red-50 p-8 text-center" role="alert">
      <div className="max-w-md">
        ...
        <h2 className="text-xl font-black text-zinc-950">Contacts could not be loaded</h2>
        <p className="mt-2 text-sm leading-6 text-zinc-600">A temporary error prevented this CRM view from loading. No Contact data was changed.</p>
